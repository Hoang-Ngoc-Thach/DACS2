                        ...
                        >
                            {!isAudio(attachment) && (
                                <a
                                    ...
                                    download
                                    href={attachment.url}
                                    className="2-20 opacity-100 group-hover:opacity-100
                                    transition-all w8 h-8 flex items-center justify-center text-gray-100 bg-gray-700 rounded absolute right-0 top-0
                            ...
                            {isVideo(attachment) && (
                                <div className="relative flex justify-center items-center">
                                    <PlayCircleIcon className="z-20 absolute w-16 h-16text-white opacity-70" />
